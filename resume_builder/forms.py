...
class ContactModelForm(forms.ModelForm):
    class Meta:
        model = Contact
        fields = ['prefix','first_name','last_name','address_1','address_2','country','state','pin','phone_number','email','linked_in','github']
...
class EducationModelForm(forms.ModelForm):
    class Meta:
        model = Education
        fields = ['school_name','board','country','state','city','degree','field_of_study','joining_date','status','passing_date','score']
...
class InternshipFormExperienceForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['name','position','country','state','city','date_of_joining','i_status','date_of_exit','description']
