...
class ViewQuizListByCategory(ListView):
    model = Quiz
    template_name = 'language/view_quiz_category.html'
...
class QuizUserProgressView(TemplateView):
    template_name = 'language/progress.html'
...
class QuizTake(FormView):
    ...
    template_name = 'language/question.html'
    result_template_name = 'language/result.html'
    single_complete_template_name = 'language/single_complete.html'
